...
@Component({
  selector: 'app-single-top-chart',
  templateUrl: './single-top-chart.component.html',
  styleUrls: ['./single-top-chart.component.css']
})
export class SingleTopChartComponent implements OnInit {
